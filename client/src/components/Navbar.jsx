...
export default function Navbar() {
  ...
  <div 
    onClick={() => user.avatar && showPreview(user.avatar, user.name)}
    className={`w-6 h-6 sm:w-7 sm:h-7 overflow-hidden bg-gradient-to-br from-primary-500 to-emerald-500 rounded-full flex items-center justify-center flex-shrink-0 transition-transform ${user.avatar ? 'cursor-zoom-in hover:scale-105' : ''}`}
  >
    {user.avatar ? (

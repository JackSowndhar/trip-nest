...
export const invitationsAPI = {
  ...
  accept: async (id) => {
    const { data } = await axios.post(`/api/invitations/${id}/accept`);
    return data;
  },
  reject: async (id) => {
    const { data } = await axios.post(`/api/invitations/${id}/reject`);
    return data;
  },
};
...
export const chatAPI = {
  getMessages: async (tripId) => {
    const { data } = await axios.get(`/api/trips/${tripId}/chat`);
    return data;
  },
};
